$(document).ready(function() {
    ...
    $("#get_group").change(function() {
        ...
        if (groupValue === '') {clearlist(); $('#sub_discipline').css('display', 'none');  }
        getdiscipline();
      })
    ...
    function getStatement() {
      ...
      if (date_value === "") {
        ...
        area.attr("disabled",false);
        area.load('../stud_statement.php',{page_id:p_id, statement:date_value, group:group_value, discipline:discipline_value});
