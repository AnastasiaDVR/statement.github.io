...
$(document).ready(function() {
    $("#saveStudents").click(function (e) {
        ...
        var myData = {"surname_student":$("#surnameStudent").val(), "name_student":$("#nameStudent").val(), "patronymic_student":$("#patronymicStudent").val(), "studentGroupList":$("#studentGroup").val()};
...
<dl id="students">
    ...
    <input onkeypress="return filter_input(event,/[А-ЯЁ]/i)" maxlength="15" id="surnameStudent" name="surname_student" type="text" placeholder="Фамилия" required>
    <input onkeypress="return filter_input(event,/[А-ЯЁ]/i)" maxlength="15" id="nameStudent" name="name_student" type="text" placeholder="Имя" required>
    <input onkeypress="return filter_input(event,/[А-ЯЁ]/i)" maxlength="15" id="patronymicStudent" name="patronymic_student" type="text" placeholder="Отчество">
