...
$(document).ready(function() {
    $("#saveUser").click(function (e) {
        ...
        var myData = {"surname_user":$("#surnameUser").val(), "name_user":$("#nameUser").val(), "patronymic_user":$("#patronymicUser").val(), "login_user":$("#loginUser").val(), "password_user":$("#passwordUser").val(), "userRoleList":$("#userRole").val()};
...
<dl id="users">
    ...
    <input onkeypress="return filter_input(event,/[А-ЯЁ]/i)" maxlength="15" id="surnameUser" name="surname_user" type="text" placeholder="Фамилия" required>
    <input onkeypress="return filter_input(event,/[А-ЯЁ]/i)" maxlength="15" id="nameUser" name="name_user" type="text" placeholder="Имя" required>
    <input onkeypress="return filter_input(event,/[А-ЯЁ]/i)" maxlength="15" id="patronymicUser" name="patronymic_user" type="text" placeholder="Отчество"><br><br>

    <input onkeypress="return filter_input(event,/[A-ZА-ЯЁ0-9]/i)" maxlength="15" id="loginUser" name="login_user" type="text" placeholder="Логин" required>
