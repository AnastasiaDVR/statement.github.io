...
$(document).ready(function() {
    $("#saveDiscipline").click(function (e) {
        ...
        var myData = {"name_discipline":$("#nameDiscipline").val(), "disciplineUserList":$("#disciplineUser").val()};
...
<dl id="disciplines">
    ...
    <input onkeypress="return filter_input(event,/[A-ZА-ЯЁ ]/i)" id="nameDiscipline" name="name_discipline" type="text" placeholder="Название дисциплины" required>
